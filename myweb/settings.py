...
SECRET_KEY = 'django-insecure-g)jpxhb5^o@nfx(xm(5@t#--oghl-%imtyimu0s)5i&4j4bii('
...
STATICFILES_DIRS = [
    ...
    r'C:\Users\QWC\Desktop\Django',#ใช้ในกรณีไฟล์ภาพอยู่ในโฟลเดอร์ Django ในหน้า Desktop
